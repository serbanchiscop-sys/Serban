/* @ds-bundle: {"format":3,"namespace":"BHSGroupDesignSystem_0dca50","components":[{"name":"Eyebrow","sourcePath":"components/brand/Eyebrow.jsx"},{"name":"Logo","sourcePath":"components/brand/Logo.jsx"},{"name":"StatBlock","sourcePath":"components/brand/StatBlock.jsx"},{"name":"Badge","sourcePath":"components/data/Badge.jsx"},{"name":"Card","sourcePath":"components/data/Card.jsx"},{"name":"Button","sourcePath":"components/forms/Button.jsx"},{"name":"Input","sourcePath":"components/forms/Input.jsx"},{"name":"Tabs","sourcePath":"components/navigation/Tabs.jsx"}],"sourceHashes":{"components/brand/Eyebrow.jsx":"af45239beb86","components/brand/Logo.jsx":"aef5db767274","components/brand/StatBlock.jsx":"8305e3314da8","components/data/Badge.jsx":"cb0490e55fec","components/data/Card.jsx":"879623b10643","components/forms/Button.jsx":"7e8bc3808664","components/forms/Input.jsx":"7f573df435e8","components/navigation/Tabs.jsx":"dbb6f2760669","decks/deck-stage.js":"208980974db4","ui_kits/website/site.jsx":"1b5b6fc688eb"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.BHSGroupDesignSystem_0dca50 = window.BHSGroupDesignSystem_0dca50 || {});
...
try { (() => {
/**
 * Tracked uppercase eyebrow label with optional accent rule.
 * The brand's recurring section-marker treatment (Sky Blue).
 */
function Eyebrow({
  children,
  color,
  ...
  const c = color || (onDark ? 'var(--bhs-sky-blue)' : 'var(--bhs-sky-blue)');
...
const SRC = {
  'primary-light': 'logo-primary-light.png',
  'primary-dark': 'logo-primary-dark.png',
  'primary-navy': 'logo-primary-navy.png',
  'vertical-light': 'logo-vertical-light.png',
  'vertical-dark': 'logo-vertical-dark.png',
  'icon': 'icon.png',
  'icon-light': 'icon-light.png',
  'icon-dark': 'icon-dark.png',
  'icon-navy': 'icon-navy.png'
};

/**
 * BHS Group logo. Pick the variant by background contrast.
 * `base` is the path to the assets/logos folder (relative to the page).
 */
function Logo({
  ...
  return /*#__PURE__*/React.createElement("img", _extends({
    src: base + '/' + (SRC[variant] || SRC['primary-light']),
    alt: alt,
    style: {
      height: height + 'px',
      width: 'auto',
...
try { (() => {
/**
 * Big-number statistic block — the brand's signature "by the numbers" unit.
 * Numbers use tabular figures and Deep Blue (or white on dark).
 */
function StatBlock({
  value,
  label,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      color: onDark ? 'var(--bhs-sky-blue)' : 'var(--text-brand)'
    }
...
function Badge({
  ...
  const tones = {
    brand: {
      fg: 'var(--bhs-deep-blue)',
      bg: 'var(--bhs-blue-100)',
      solidBg: 'var(--bhs-deep-blue)'
    },
    neutral: {
      fg: 'var(--bhs-gray-700)',
      bg: 'var(--bhs-gray-100)',
      solidBg: 'var(--bhs-gray-700)'
    },
    success: {
      fg: 'var(--bhs-success)',
      bg: '#E3F3EC',
      solidBg: 'var(--bhs-success)'
    },
    warning: {
      fg: 'var(--bhs-warning)',
      bg: '#FCF0DC',
      solidBg: 'var(--bhs-warning)'
    },
    danger: {
      fg: 'var(--bhs-danger)',
      bg: '#F8E4E1',
      solidBg: 'var(--bhs-danger)'
    },
    info: {
      fg: 'var(--bhs-cyan)',
      bg: 'var(--bhs-blue-100)',
      solidBg: 'var(--bhs-cyan)'
    }
  };
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Surface card. Optional eyebrow, title, body and footer.
 * `accent` adds a top Sky-Blue rule; `interactive` adds hover lift.
 */
function Card({
  children,
  title,
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    style: {
      ...
      borderTop: accent ? '3px solid var(--bhs-sky-blue)' : '1px solid var(--border-subtle)',
    ...
    style: {
      ...
      background: 'var(--bhs-blue-50)',
      color: 'var(--bhs-deep-blue)',
      display: 'flex',
      alignItems: 'center',
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * BHS Group primary button.
 * Variants: primary (Deep Blue), secondary (outline), ghost, danger.
 */
function Button({
  children,
  variant = 'primary',
...
function Input({
  ...
  const borderColor = error ? 'var(--bhs-danger)' : focus ? 'var(--bhs-sky-blue)' : 'var(--border-default)';
  return /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--font-sans)',
      width: '100%'
    ...
    style: {
      fontSize: '12px',
      marginTop: '6px',
      color: error ? 'var(--bhs-danger)' : 'var(--text-muted)'
    }
  }, error || helper));
}
...
try { (() => {
/**
 * Underline tabs. `items` is [{ id, label }]. Controlled via value/onChange,
...
try { (() => {
/* BHS Group marketing website — section components.
   Composes design-system primitives from window.BHSGroupDesignSystem_0dca50.
   Loaded as a Babel script; exports sections to window. */

const NS = window.BHSGroupDesignSystem_0dca50;
const {
  Button,
  Card,
  Badge,
...
/* ---- Icon set: Lucide (MIT), 24×24 / 2px stroke. Substituted set — see ICONOGRAPHY. ---- */
function Icon({
  name,
  size = 24,
  color = 'currentColor',
  ...
  const P = {
    cloud: /*#__PURE__*/React.createElement("path", {
      d: "M17.5 19a4.5 4.5 0 0 0 0-9h-1.8A7 7 0 1 0 4 16.5"
    }),
    ...
    headset: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
      d: "M3 11h3v6H3a1 1 0 0 1-1-1v-4a1 1 0 0 1 1-1Zm15 0h3a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-3v-6Z"
    }), /*#__PURE__*/React.createElement("path", {
      d: "M4 11a8 8 0 0 1 16 0"
    }), /*#__PURE__*/React.createElement("path", {
      d: "M18 17a4 4 0 0 1-4 3h-2"
    })),
...
const NAV = ['Services', 'Results', 'About', 'Contact'];
...
function Header({
  ...
  return /*#__PURE__*/React.createElement("header", {
    ...
    style: {
      ...
      color: active === n ? 'var(--text-brand)' : 'var(--text-body)',
      textDecoration: 'none',
      padding: '8px 14px',
      borderRadius: 'var(--radius-pill)'
    }
...
function Hero({
  ...
  return /*#__PURE__*/React.createElement("section", {
    style: {
      position: 'relative',
      background: 'var(--bhs-gradient-hero)',
      overflow: 'hidden'
    }
  }, /*#__PURE__*/React.createElement("div", {
    "aria-hidden": "true",
    style: {
      ...
      width: 520,
      height: 520,
      background: 'radial-gradient(circle, rgba(76,168,228,0.35), transparent 60%)'
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: 1200,
    ...
    rule: true,
    onDark: true
  }, "Business Hybrid Solutions"), /*#__PURE__*/React.createElement("h1", {
    style: {
      margin: '22px 0 0',
      fontFamily: 'var(--font-sans)',
      fontWeight: 800,
  ...
  }, "Connecting technology with opportunity."), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: '24px 0 0',
      maxWidth: 600,
      fontFamily: 'var(--font-sans)',
  ...
  }, "We bring on-prem and cloud together under one operating model \u2014 predictable cost, consistent SLAs, and systems that finally talk to each other."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 14,
      marginTop: 36,
...
function TrustBand() {
  const items = [{
    ...
    icon: 'shield',
    label: 'ISO-aligned security'
  }, {
    icon: 'gauge',
    label: '99.95% uptime SLA'
  }, {
    icon: 'headset',
    label: 'Named engineers'
  }];
  return /*#__PURE__*/React.createElement("div", {
    style: {
      borderBottom: '1px solid var(--border-subtle)',
...
const SERVICES = [{
  ...
  body: 'On-prem and cloud workloads managed together — predictable cost, consistent SLAs, no lock-in.'
}, {
  icon: 'headset',
  eyebrow: 'Managed services',
  title: 'Always-on operations',
  body: 'Round-the-clock monitoring, patching, and response — measured against business outcomes, not tickets.'
}, {
  icon: 'merge',
  eyebrow: 'Integration',
  title: 'Systems that connect',
  body: 'ERP, CRM, identity and operations data flowing end-to-end, with no re-keying and no silos.'
}, {
  icon: 'shield',
  eyebrow: 'Security & compliance',
  title: 'Resilient by default',
  body: 'Identity-first controls, backup and recovery, and audit-ready posture across the whole estate.'
}, {
  icon: 'layers',
  eyebrow: 'Modernisation',
  title: 'Migrate with confidence',
  body: 'Assess, plan, and move legacy workloads on a phased roadmap with owners and timing made clear.'
}, {
  icon: 'spark',
  eyebrow: 'Advisory',
  title: 'A practical roadmap',
  body: 'Strategy grounded in evidence — timelines, TCO, and the next three things worth doing.'
}];
function Services({
  heading = true
}) {
  ...
  }, "Capabilities that combine \u2014 that's the hybrid."), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: '16px 0 0',
      fontFamily: 'var(--font-sans)',
      fontSize: 17,
  ...
  }, "Pick one or run the whole estate with us. Either way you get a single operating model and one team accountable for outcomes.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
...
function StatsBand() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    sublabel: "Across managed workloads.",
    onDark: true
  }), /*#__PURE__*/React.createElement(StatBlock, {
    value: "38%",
    label: "Avg. cost reduction",
    sublabel: "Year-1 TCO vs. legacy baseline.",
    onDark: true
  }), /*#__PURE__*/React.createElement(StatBlock, {
    value: "<90",
    label: "Days to first value",
    sublabel: "Median across hybrid migrations.",
    onDark: true
  }), /*#__PURE__*/React.createElement(StatBlock, {
    value: "24/7",
    label: "Monitoring & response",
    sublabel: "Named engineers, every shift.",
    onDark: true
  }))));
}
...
function CaseStudy() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: {
      ...
      background: 'var(--bhs-gradient-tile)',
      position: 'relative',
      overflow: 'hidden',
  ...
  }, "Case in point")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Eyebrow, {
    rule: true
  }, "Customer voice"), /*#__PURE__*/React.createElement("blockquote", {
    style: {
      margin: '24px 0 0',
      fontFamily: 'var(--font-sans)',
  ...
  }, "\u201CBHS Group cut our deployment time in half and gave us a single pane of glass over the whole stack. That clarity changed how we plan.\u201D"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 28,
      display: 'flex',
      alignItems: 'center',
  ...
  }, "Ana Moreno"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--font-sans)',
      color: 'var(--text-muted)',
      fontSize: 13
    }
  }, "CIO \xB7 Log\xEDstica Iberia"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 10,
      marginTop: 28
    ...
    tone: "success",
    dot: true
  }, "99.95% uptime"), /*#__PURE__*/React.createElement(Badge, {
    tone: "brand"
  }, "12 wk to live"), /*#__PURE__*/React.createElement(Badge, {
    tone: "info"
  }, "38% saved")))));
}
...
function CtaBand({
  ...
  }, "Let's get to work."), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: '16px auto 0',
      maxWidth: 520,
      fontFamily: 'var(--font-sans)',
  ...
  }, "Tell us what's slowing you down. We'll come back with a practical first step within two working days."), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 32,
      display: 'flex',
      justifyContent: 'center'
...
function Footer() {
  return /*#__PURE__*/React.createElement("footer", {
  ...
  }, "Business Hybrid Solutions \u2014 combining systems, processes and technology for measurable outcomes.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 56,
      flexWrap: 'wrap'
    ...
    title: "Company",
    links: ['Services', 'Results', 'About', 'Careers']
  }), /*#__PURE__*/React.createElement(FootCol, {
    title: "Contact",
    links: ['partners@bhsgroup.es', 'bhsgroup.es']
  }))), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\xA9 2026 BHS Group \xB7 Business Hybrid Solutions")));
}
function FootCol({
  title,
  links
...
function ContactPage() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    rule: true
  }, "Let's get to work"), /*#__PURE__*/React.createElement("h2", {
    style: {
      margin: '20px 0 0',
      fontFamily: 'var(--font-sans)',
      fontWeight: 800,
  ...
  }, "Connecting technology", /*#__PURE__*/React.createElement("br", null), "with opportunity."), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: '18px 0 28px',
      fontFamily: 'var(--font-sans)',
      fontSize: 17,
  ...
  }, "Tell us where you are today and where you want to be. We'll reply within two working days with a practical first step."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 14
    ...
    rows: 4,
    placeholder: "A line or two about your estate and goals\u2026",
    style: {
      width: '100%',
...
Object.assign(window, {
  BHSHeader: Header,
  BHSHero: Hero,
  BHSTrustBand: TrustBand,
  BHSServices: Services,
  BHSStatsBand: StatsBand,
  BHSCaseStudy: CaseStudy,
  BHSCtaBand: CtaBand,
  BHSFooter: Footer,
  BHSContactPage: ContactPage,
  BHSIcon: Icon
});
